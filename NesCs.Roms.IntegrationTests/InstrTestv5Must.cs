...
{
    [Theory]
    [InlineData("instr_test-v5/rom_singles/01-basics.nes", 0xE976, "\n01-basics\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/02-implied.nes", 0xE976, "\n02-implied\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/03-immediate.nes", 0xE976, "\n03-implied\n\nPassed\n", Skip = "Must implement 0x0B")]
    [InlineData("instr_test-v5/rom_singles/04-zero_page.nes", 0xE976, "\n04-zero_page\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/05-zp_xy.nes", 0xE976, "\n05-zp_xy\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/06-absolute.nes", 0xE976, "\n06-absolute\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/07-abs_xy.nes", 0xE976, "", Skip = "Must implement 0x9C?")]
    [InlineData("instr_test-v5/rom_singles/08-ind_x.nes", 0xE976, "\n08-ind_x\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/09-ind_y.nes", 0xE876, "\n09-ind_y\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/10-branches.nes", 0xE876, "\n10-branches\n\nPassed\n")]
    [InlineData("instr_test-v5/rom_singles/11-stack.nes", 0xE876, "\n11-stack\n\nPassed\n")]
    ...
    [InlineData("instr_test-v5/rom_singles/16-special.nes", 0xE8D5, "\n16-special\n\nPassed\n")]
