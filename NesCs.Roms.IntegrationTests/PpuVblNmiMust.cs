...
{
    [Theory]
    [InlineData("ppu_vbl_nmi/rom_singles/01-vbl_basics.nes", 0xE8D5, 0, "\n01-vbl_basics\n\nPassed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/02-vbl_set_time.nes", 0xE8D5, 0, "T+ 1 2\n00 - V\n01 - V\n02 - V\n03 - V\n04 - -\n05 V -\n06 V -\n07 V -\n08 V -\n\n02-vbl_set_time\n\nPassed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/03-vbl_clear_time.nes", 0xE8D5, 1, "00 V\n01 V\n02 V\n03 V\n04 V\n05 -\n06 -\n07 -\n08 -\n\n06C2316A\n03-vbl_clear_time\n\nFailed\n")] // Better
                                                                         // "00 V\n01 V\n02 -\n03 -\n04 -\n05 -\n06 -\n07 -\n08 -\n\nF40A7AF2\n03-vbl_clear_time\n\nFailed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/04-nmi_control.nes", 0xE8D5, 0, "\n04-nmi_control\n\nPassed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/05-nmi_timing.nes", 0xE8D5, 1, "00 3\n01 3\n02 3\n03 3\n04 3\n05 3\n06 2\n07 2\n08 2\n09 2\n\nCDB40123\n05-nmi_timing\n\nFailed\n")] // Worse
                                                                      //"00 4\n01 4\n02 3\n03 3\n04 3\n05 3\n06 3\n07 3\n08 2\n09 2\n\n3C0FD427\n05-nmi_timing\n\nFailed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/06-suppression.nes", 0xE8D5, 1, "00 - N\n01 - N\n02 - N\n03 - -\n04 - N\n05 V N\n06 V N\n07 V N\n08 V N\n09 V N\n\nF73B4983\n06-suppression\n\nFailed\n")] // Worse
                                                                       //"00 - N\n01 - N\n02 - N\n03 - N\n04 - -\n05 V -\n06 V N\n07 V N\n08 V N\n09 V N\n\n9C51DAF3\n06-suppression\n\nFailed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/07-nmi_on_timing.nes", 0xE8D5, 0, "00 N\n01 N\n02 N\n03 N\n04 N\n05 -\n06 -\n07 -\n08 -\n\n07-nmi_on_timing\n\nPassed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/08-nmi_off_timing.nes", 0xE8D5, 1, "03 -\n04 N\n05 N\n06 N\n07 N\n08 N\n09 N\n0A N\n0B N\n0C N\n\n6CB785AD\n08-nmi_off_timing\n\nFailed\n")] // Worse
    [InlineData("ppu_vbl_nmi/rom_singles/09-even_odd_frames.nes", 0xE8D5, 0, "00 01 01 02 \n09-even_odd_frames\n\nPassed\n")]
    [InlineData("ppu_vbl_nmi/rom_singles/10-even_odd_timing.nes", 0xEAD5, 0, "08 08 09 07 \n10-even_odd_timing\n\nPassed\n")]
    public void BeExecutedCorrectly(string romName, int poweroffAddress, int expectedValue, string expectedResult)
    {
        ...
        Assert.Equal(expectedValue, ram[0x6000]);
