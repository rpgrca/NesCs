...
public partial class Cpu6502
{
    public class Builder
    {
        ...
        public Builder()
        {
            ...
            _instructions[0x06] = new Instruction(0x06, "ASL", A.ZeroPage, O.ShiftLeft);
            ...
            _instructions[0x0E] = new Instruction(0x0E, "ASL", A.Absolute, O.ShiftLeft);
            ...
            _instructions[0x25] = new Instruction(0x25, "AND", A.ZeroPage, O.And);
            _instructions[0x26] = new RotateLeftZeroPageOpcode26();
            _instructions[0x28] = new PullProcessorStatusOpcode28();
            _instructions[0x29] = new Instruction(0x29, "AND", A.Immediate, O.And);
            ...
            _instructions[0x31] = new Instruction(0x31, "AND", A.IndirectYIndexed, O.And);
            _instructions[0x35] = new Instruction(0x35, "AND", A.ZeroPageXIndexed, O.And);
            _instructions[0x36] = new RotateLeftZeroPageXOpcode36();
            _instructions[0x38] = new SetCarryFlagOpcode38();
            _instructions[0x39] = new Instruction(0x39, "AND", A.AbsoluteYIndexed, O.And);
            _instructions[0x3D] = new Instruction(0x3D, "AND", A.AbsoluteXIndexed, O.And);
            ...
            _instructions[0x61] = new Instruction(0x61, "ADC", A.IndirectXIndexed, O.AddWithCarry);
            _instructions[0x65] = new Instruction(0x65, "ADC", A.ZeroPage, O.AddWithCarry);
            _instructions[0x66] = new RotateRightZeroPageOpcode66();
            _instructions[0x68] = new PullAccumulatorOpcode68();
            _instructions[0x69] = new Instruction(0x69, "ADC", A.Immediate, O.AddWithCarry);
            _instructions[0x6A] = new RotateRightAccumulatorOpcode6A();
            _instructions[0x6C] = new JumpInIndirectModeOpcode6C();
            _instructions[0x6D] = new Instruction(0x6D, "ADC", A.Absolute, O.AddWithCarry);
            _instructions[0x6E] = new RotateRightAbsoluteOpcode6E();
            _instructions[0x70] = new BranchIfOverflowSetOpcode70();
            _instructions[0x71] = new Instruction(0x71, "ADC", A.IndirectYIndexed, O.AddWithCarry);
            _instructions[0x75] = new Instruction(0x75, "ADC", A.ZeroPageXIndexed, O.AddWithCarry);
            _instructions[0x76] = new RotateRightZeroPageXOpcode76();
            _instructions[0x78] = new SetInterruptDisableOpcode78();
            _instructions[0x79] = new Instruction(0x79, "ADC", A.AbsoluteYIndexed, O.AddWithCarry);
            _instructions[0x7D] = new Instruction(0x7D, "ADC", A.AbsoluteXIndexed, O.AddWithCarry);
            ...
            _instructions[0xC0] = new Instruction(0xC0, "CMP", A.Immediate, O.Compare.Y);
            _instructions[0xC1] = new Instruction(0xC1, "CMP", A.IndirectXIndexed, O.Compare.Accumulator);
            _instructions[0xC4] = new Instruction(0xC4, "CMP", A.ZeroPage, O.Compare.Y);
            _instructions[0xC5] = new Instruction(0xC5, "CMP", A.ZeroPage, O.Compare.Accumulator);
            _instructions[0xC6] = new DecrementMemoryZeroPageOpcodeC6();
            _instructions[0xC8] = new IncrementYOpcodeC8();
            _instructions[0xC9] = new Instruction(0xC9, "CMP", A.Immediate, O.Compare.Accumulator);
            _instructions[0xCA] = new DecrementXOpcodeCA();
            _instructions[0xCC] = new Instruction(0xCC, "CMP", A.Absolute, O.Compare.Y);
            _instructions[0xCD] = new Instruction(0xCD, "CMP", A.Absolute, O.Compare.Accumulator);
            _instructions[0xCE] = new DecrementMemoryAbsoluteOpcodeCE();
            _instructions[0xD0] = new BranchIfNotEqualOpcodeD0();
            _instructions[0xD1] = new Instruction(0xD1, "CMP", A.IndirectYIndexed, O.Compare.Accumulator);
            _instructions[0xD5] = new Instruction(0xD5, "CMP", A.ZeroPageXIndexed, O.Compare.Accumulator);
            ...
            _instructions[0xD9] = new Instruction(0xD9, "CMP", A.AbsoluteYIndexed, O.Compare.Accumulator);
        ...
        private void AddInvalidOpcodes()
        {
            ...
            _instructions[0x1A] = new Instruction(0x1A, "NOP*", A.Implied, O.Nop);
            ...
            _instructions[0x3A] = new Instruction(0x3A, "NOP*", A.Implied, O.Nop);
            ...
            _instructions[0x5A] = new Instruction(0x5A, "NOP*", A.Implied, O.Nop);
            ...
            _instructions[0x7A] = new Instruction(0x7A, "NOP*", A.Implied, O.Nop);
            ...
            _instructions[0xDA] = new Instruction(0xDA, "NOP*", A.Implied, O.Nop);
            ...
            _instructions[0xFA] = new Instruction(0xFA, "NOP*", A.Implied, O.Nop);
