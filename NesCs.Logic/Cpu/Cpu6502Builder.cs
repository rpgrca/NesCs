...
public partial class Cpu6502
{
    public class Builder
    {
        ...
        public Builder()
        {
            ...
            _instructions[0x36] = new Instruction(0x36, "ROL", As.ZeroPageXIndexed, Doing.RotateLeft);
            ...
            _instructions[0x3E] = new Instruction(0x3E, "ROL", As.AbsoluteXIndexed.WithExtraRead, Doing.RotateLeft);
