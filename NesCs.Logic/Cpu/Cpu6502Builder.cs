...
public partial class Cpu6502
{
    public class Builder
    {
        ...
        public Builder()
        {
            ...
            _instructions[0x06] = new Instruction(0x06, "ASL", As.ZeroPage, Doing.ShiftLeft.Memory);
            ...
            _instructions[0x0E] = new Instruction(0x0E, "ASL", As.Absolute, Doing.ShiftLeft.Memory);
            ...
            _instructions[0x16] = new Instruction(0x16, "ASL", As.ZeroPageXIndexed, Doing.ShiftLeft.Memory);
            ...
            _instructions[0x26] = new Instruction(0x26, "ROL", As.ZeroPage, Doing.RotateLeft.OnMemory);
            ...
            _instructions[0x2E] = new Instruction(0x2E, "ROL", As.Absolute, Doing.RotateLeft.OnMemory);
            ...
            _instructions[0x36] = new Instruction(0x36, "ROL", As.ZeroPageXIndexed, Doing.RotateLeft.OnMemory);
            ...
            _instructions[0x66] = new Instruction(0x66, "ROR", As.ZeroPage, Doing.RotateRight.OnMemory);
            ...
            _instructions[0x6E] = new Instruction(0x6E, "ROR", As.Absolute, Doing.RotateRight.OnMemory);
            ...
            _instructions[0x76] = new Instruction(0x76, "ROR", As.ZeroPageXIndexed, Doing.RotateRight.OnMemory);
            ...
            _instructions[0xA4] = new Instruction(0xA4, "LDY", As.ZeroPage, Doing.Load.Y);
            _instructions[0xA5] = new Instruction(0xA5, "LDA", As.ZeroPage, Doing.Load.Accumulator);
            _instructions[0xA6] = new Instruction(0xA6, "LDX", As.ZeroPage, Doing.Load.X);
            ...
            _instructions[0xAC] = new Instruction(0xAC, "LDY", As.Absolute, Doing.Load.Y);
            _instructions[0xAD] = new Instruction(0xAD, "LDA", As.Absolute, Doing.Load.Accumulator);
            _instructions[0xAE] = new Instruction(0xAE, "LDX", As.Absolute, Doing.Load.X);
            ...
            _instructions[0xB4] = new Instruction(0xB4, "LDY", As.ZeroPageXIndexed, Doing.Load.Y);
            _instructions[0xB5] = new Instruction(0xB5, "LDA", As.ZeroPageXIndexed, Doing.Load.Accumulator);
            _instructions[0xB6] = new Instruction(0xB6, "LDX", As.ZeroPageYIndexed, Doing.Load.X);
