...
public class NesFileMust
{
    ...
    public void CreateNesFile_WhenFileHasValidHeader(byte[] fileContents, int expectedProgramRomSize, int expectedCharacterRomSize, Mirroring expectedMirroring,
        ...
        bool expectedProgramRam, bool expectedBusConflicts)
    {
    ...
    public static IEnumerable<object[]> NesFileHeaderFeeder()
    {
        ...
        /* Nes20 */
        yield return new object[] { new byte[] { 0x4e, 0x45, 0x53, 0x1A, 0x20, 0x10, 0b01111100, 0b11111001, 0x10, 0b1, 0b110001, 0x00, 0x00, 0x00, 0x00, 0x00 }, 32, 16,
            /* Flags6  */ Mirroring.Horizontal, false, true, true,
        ...
        /* Nes20 */
        yield return new object[] { new byte[] { 0x4e, 0x45, 0x53, 0x1A, 0x20, 0x10, 0b01111100, 0b11111010, 0x10, 0b1, 0b110001, 0x00, 0x00, 0x00, 0x00, 0x00 }, 32, 16,
            /* Flags6  */ Mirroring.Horizontal, false, true, true,
