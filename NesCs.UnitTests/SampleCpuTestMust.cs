...
public class Cpu6502ProcessorMust
{
    ...
    public void ExecuteB5SampleTestCorrectly(string jsonText)
    {
        ...
        var sut = new Cpu6502.Builder()
            .RunningProgram(Convert.FromHexString(data.Name.Replace(" ", "")).Take(2).ToArray())
...
""" };
		yield return new object[] { """{ "name": "b5 6d 7e", "initial": { "pc": 27808, "s": 113, "a": 156, "x": 116, "y": 192, "p": 233, "ram": [ [27808, 181], [27809, 109], [27810, 126], [109, 139], [225, 49]]}, "final": { "pc": 27810, "s": 113, "a": 49, "x": 116, "y": 192, "p": 105, "ram": [ [109, 139], [225, 49], [27808, 181], [27809, 109], [27810, 126]]}, "cycles": [ [27808, 181, "read"], [27809, 109, "read"], [109, 139, "read"], [225, 49, "read"]] }""" };
